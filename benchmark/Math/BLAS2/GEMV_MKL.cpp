...
namespace {
    ...
    void gemv_mkl(benchmark::State& state) {
...
BENCHMARK(gemv_mkl<float64, MatrixMajor::Col>)->Name("GEMV col mkl")->Arg(16)->Arg(32)->Arg(512);
BENCHMARK(gemv_mkl<float64, MatrixMajor::Row>)->Name("GEMV row mkl")->Arg(16)->Arg(32)->Arg(512);
