...
$\quad$Overall, Physica employs a goal-oriented, layered structure that progressively exposes complexity. Users not concerned with implementation details will generally encounter fewer such details, as most common use cases are addressed at shallower directory levels. Since scientific workflows are diverse and often require flexibility, 
we respect users' right to access and modify any underlying details. The pervasive use of templates further facilitates non-intrusive customization and extension.
