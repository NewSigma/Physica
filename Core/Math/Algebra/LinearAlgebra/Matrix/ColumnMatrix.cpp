...
namespace Physica::Core {
    ...
    ColumnMatrix::ColumnMatrix(const CStyleArray<Vector>& array) : Matrix(array, Column) {}

    ColumnMatrix::ColumnMatrix(CStyleArray<Vector>&& array) noexcept : Matrix(std::move(array), Column) {}
