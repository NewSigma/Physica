...
namespace {
    const char* const data = "Structure\n"
                             "1\n"
                             "4.591253757           0           0\n"
