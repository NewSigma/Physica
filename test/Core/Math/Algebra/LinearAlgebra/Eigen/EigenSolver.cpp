...
int main() {
    ...
    {
        using M = DenseMatrix<RealType, MatrixOption::Col | MatrixOption::Vector, 3, 3>;
        const M mat1{{-0.590316, -2.19514, -2.37463},
        ...
        const M mat2{{0.354784, 0.604092, 0.557408},
    ...
    /* Test Row Major */ {
        using M = DenseMatrix<RealType, MatrixOption::Row | MatrixOption::Vector, 3, 3>;
        const M mat1{{-0.590316, -2.19514, -2.37463},
                     {-1.25006, -0.297493, 1.40349},
                     {0.517063, -0.956614, -0.920775}};
        if (!eigenTest(mat1, 1E-14))
    ...
    {
        using M = DenseMatrix<RealType, MatrixOption::Col | MatrixOption::Vector, 5, 5>;
        const M mat1{{0.200743, 0.151314, 0.152894, 0.934051, 0.487404},
        ...
        const M mat2 {{0.502016, 0.812053, 0.0716913, 0.180531, 0.0161382},
    ...
    /* Test degeneracy */ {
        using M = DenseMatrix<RealType, MatrixOption::Col | MatrixOption::Vector, 6, 6>;
        const M mat1{{ 0.1343184046,             0,             0, -0.1343184056,             0,             0},
