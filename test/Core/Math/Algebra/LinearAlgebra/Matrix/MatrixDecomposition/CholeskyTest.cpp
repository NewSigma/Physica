...
int main() {
    {
        typedef DenseMatrix<Scalar<Double>, MatrixOption::Column | MatrixOption::Element, 3, 3> Matrix3x3;
    ...
    {
        typedef DenseMatrix<Scalar<Double>, MatrixOption::Column | MatrixOption::Vector, 3, 3> Matrix3x3;
        Matrix3x3 mat{{5, -2, 0}, {-2, 3, -1}, {0, -1, 1}};
        Cholesky cholesky(mat);
        Matrix3x3 decomp(cholesky);
        Matrix3x3 answer{{sqrt(5), -2 / sqrt(5), 0}, {0, sqrt(11.0 / 5), -sqrt(5.0 / 11)}, {0, 0, sqrt(6.0 / 11)}};
    ...
    {
        using Matrix5x5 = DenseMatrix<Scalar<Double>, MatrixOption::Column | MatrixOption::Vector, 5, 5>;
        const Matrix5x5 mat{
