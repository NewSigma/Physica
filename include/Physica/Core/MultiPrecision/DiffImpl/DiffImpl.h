...
namespace Physica::Core {
    ...
    template<class ScalarType, unsigned int Order>
    Diff<ScalarType, DiffMode::Forward, Order>::Diff(ScalarType value_, ScalarType grad_)
    ...
    inline typename Diff<ScalarType, DiffMode::Reverse, Order>::template GradReturnType<GradOrder>&
    ...
    template<class ScalarType, unsigned int Order>
    template<unsigned int GradOrder>
    inline const typename Diff<ScalarType, DiffMode::Reverse, Order>::template GradReturnType<GradOrder>&
