...
namespace Physica::Core {
    ...
    class device_obj<VectorExpr<ExpressionType::Div, VectorType, ScalarBase<AnyScalar>>>
            : public device_obj<BinaryVectorExpr<ExpressionType::Div, VectorType, ScalarBase<AnyScalar>>> {
        using Base = device_obj<BinaryVectorExpr<ExpressionType::Div, VectorType, ScalarBase<AnyScalar>>>;
