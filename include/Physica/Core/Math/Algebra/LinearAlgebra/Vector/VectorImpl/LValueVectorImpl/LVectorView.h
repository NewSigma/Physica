...
namespace Physica {
    ...
    class LVectorView : public RVectorView<V> {
        ...
        class Iterator;
    public:
        [[gnu::always_inline]] constexpr LVectorView(V& vec) noexcept : Base(vec) {}
...
namespace Physica {
    ...
    public:
        ...
        [[gnu::always_inline]] constexpr Iterator(const LVectorView<V>* view, difference_type index) noexcept;
