...
namespace Physica {
    ...
    template<Matrix T>
    __host__ __device__ auto device_obj<FlattenC<T>>::data_ptr(size_t index) noexcept -> PtrTy {
    ...
    template<Matrix T>
    __host__ __device__ auto device_obj<FlattenC<T>>::data_ptr(size_t index) const noexcept -> ConstPtrTy {
