...
namespace Physica::Core {
     ...
     */
    template<ExpressionType Type, class T1, class T2 = T1> class MatrixExpr;

    template<ExpressionType ExprType, class MatrixType>
    class UnitaryMatrixExpr : public RValueMatrix<MatrixExpr<ExprType, MatrixType>> {
        using This = UnitaryMatrixExpr<ExprType, MatrixType>;
    ...
    class BinaryMatrixExpr : public RValueMatrix<MatrixExpr<ExprType, LHS, RHS>> {
        static_assert(Internal::is_matrix<LHS>::value, "[Error]: Invalid left hand side type");
        using This = BinaryMatrixExpr<ExprType, LHS, RHS>;
        using Base = RValueMatrix<This>;
        using LHS1 = LHS;
...
namespace Physica {
    template<Core::ExpressionType Type, class T1, class T2>
    class Traits<Core::MatrixExpr<Type, T1, T2>> {
        ...
        constexpr static bool IsReal = Type == ExpressionType::Abs || Type == ExpressionType::Square;
