...
namespace Physica::Core {
    /**
     * Hold public part among schur-like classes. E.g. \class Schur and \class SymmEigenSolver
     */
    class AbstractSchur {
    protected:
        ...
        static size_t activeWindowLower(LValueMatrix<MatrixType>& __restrict mat, size_t upper);
    };
     ...
     */
    template<class MatrixType>
    size_t AbstractSchur::activeWindowLower(LValueMatrix<MatrixType>& __restrict mat, size_t upper) {
