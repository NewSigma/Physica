...
namespace Physica::Core {
    ...
    class DenseMatrix<T, DenseMatrixType::ElementColumn, maxRow, maxColumn> : private Utils::CStyleArray<T, maxRow * maxColumn> {
    public:
    ...
    public:
        ...
        /* Getters */
        [[nodiscard]] constexpr static DenseMatrixType getType() { return DenseMatrixType::VectorColumn; }
     ...
     */
    template<class T, size_t maxRow, size_t maxColumn>
    class DenseMatrix<T, DenseMatrixType::ElementRow, maxRow, maxColumn> : private Utils::CStyleArray<T, maxRow * maxColumn> {
    public:
        typedef Utils::CStyleArray<T, maxRow * maxColumn> Base;
    private:
        size_t row;
    ...
    public:
        ...
        typename Base::Iterator end() { return Base::end(); } //NOLINT virtual is not essential.
        /* Getters */
        [[nodiscard]] constexpr static DenseMatrixType getType() { return DenseMatrixType::ElementRow; }
        [[nodiscard]] size_t getRow() const { return row; }
        [[nodiscard]] size_t getColumn() const { return column; }
    };
    /*!
     ...
     */
    template<class T, size_t maxRow, size_t maxColumn>
    class DenseMatrix<T, DenseMatrixType::VectorColumn, maxRow, maxColumn>
    ...
    public:
        ...
        DenseMatrix<T, DenseMatrixType::VectorColumn, Utils::Dynamic, maxColumn> cutMatrixRow(size_t from);
        DenseMatrix<T, DenseMatrixType::VectorColumn, maxRow, Utils::Dynamic> cutMatrixColumn(size_t from);
     ...
     */
    template<class T, size_t maxRow, size_t maxColumn>
    class DenseMatrix<T, DenseMatrixType::VectorRow, maxRow, maxColumn>
    ...
    public:
        ...
        VectorType cutRow();
        VectorType cutColumn();
        DenseMatrix<T, DenseMatrixType::VectorRow, Utils::Dynamic, maxColumn> cutMatrixRow(size_t from);
        DenseMatrix<T, DenseMatrixType::VectorRow, maxRow, Utils::Dynamic> cutMatrixColumn(size_t from);
        void rowSwap(size_t r1, size_t r2) noexcept;
        void columnSwap(size_t c1, size_t c2) noexcept;
        void rowReduce(size_t r1, size_t r2, size_t element);
        void columnReduce(size_t c1, size_t c2, size_t element);
        /* Getters */
        [[nodiscard]] constexpr static DenseMatrixType getType() { return DenseMatrixType::VectorRow; }
