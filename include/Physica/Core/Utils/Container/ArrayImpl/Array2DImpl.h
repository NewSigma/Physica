...
namespace Physica {
    ...
    Array2D<T, Major, Row, Col, Allocator>::Array2D(size_t order)
            : Array2D(order, order) {}
    ...
    template<class T, int Major, size_t Row, size_t Col, class Allocator>
    Array2D<T, Major, Row, Col, Allocator>::Array2D(std::initializer_list<T> list) : arr(std::move(list)) {
        static_assert(Row != Dynamic || Col != Dynamic, "[Error]: Either row or col must be given at compile");
    }

    template<class T, int Major, size_t Row, size_t Col, class Allocator>
    Array2D<T, Major, Row, Col, Allocator>::Array2D(std::initializer_list<ArrayType> list)
    ...
    template<class T, int Major, size_t Row, size_t Col, class Allocator>
    const T& Array2D<T, Major, Row, Col, Allocator>::operator[](size_t r, size_t c) const {
        return const_cast<This&>(*this).operator[](r, c);
    }

    template<class T, int Major, size_t Row, size_t Col, class Allocator>
    void Array2D<T, Major, Row, Col, Allocator>::resize(size_t row, size_t col, auto&&... args) {
    ...
    template<class T, int Major, size_t Row, size_t Col, class Allocator>
    void Array2D<T, Major, Row, Col, Allocator>::resize(size_t order) {
        resize(order, order);
    }
    ...
    template<class T, int Major, size_t Row, size_t Col, class Allocator>
    void Array2D<T, Major, Row, Col, Allocator>::swap(This& __restrict obj) noexcept {
    ...
    template<class T, int Major, size_t Row, size_t Col, class Allocator>
    void Array2D<T, Major, Row, Col, Allocator>::swap_row(size_t r1, size_t r2) noexcept {
    ...
    template<class T, int Major, size_t Row, size_t Col, class Allocator>
    void Array2D<T, Major, Row, Col, Allocator>::swap_col(size_t c1, size_t c2) noexcept {
    ...
    template<class T, int Major, size_t Row, size_t Col, class Allocator>
    __host__ __device__ size_t Array2D<T, Major, Row, Col, Allocator>::getRow() const noexcept {
    ...
    template<class T, int Major, size_t Row, size_t Col, class Allocator>
    __host__ __device__ size_t Array2D<T, Major, Row, Col, Allocator>::getCol() const noexcept {
        if constexpr (Col == Dynamic) {
            const size_t size = getSize();
            if constexpr (Row == Dynamic) {
    ...
    template<class T, int Major, size_t Row, size_t Col, class Allocator>
    __host__ __device__ size_t Array2D<T, Major, Row, Col, Allocator>::getSize() const noexcept {
    ...
    template<class T, int Major, size_t Row, size_t Col, class Allocator>
    __host__ __device__ size_t Array2D<T, Major, Row, Col, Allocator>::getMaxMinor() const noexcept {
        return isColMajor ? getRow() : getCol();
    }

    template<class T, int Major, size_t Row, size_t Col, class Allocator>
    __host__ __device__ bool Array2D<T, Major, Row, Col, Allocator>::empty() const noexcept {
        return arr.empty();
    }
    /**
     ...
     */
    template<class T, int Major, size_t Row, size_t Col, class Allocator>
    auto Array2D<T, Major, Row, Col, Allocator>::read(size_t row, size_t col, const T* __restrict p) noexcept -> This {
        This result{};
    ...
    template<class T, int Major, size_t Row, size_t Col, class Allocator>
    __host__ __device__ size_t Array2D<T, Major, Row, Col, Allocator>::toIndex1D(size_t r, size_t c) const noexcept {
        assert(r < getRow());
        assert(c < getCol());
        if constexpr (isColMajor)
            return getRow() * c + r;
