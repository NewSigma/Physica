...
namespace Physica::Core {
    ...
    void RPMD<ScalarType, PosScalarType, Dim>::nvt_step(RandomGenerator& gen, const ForceModel& force) {
    ...
    template<class ScalarType, class PosScalarType, unsigned int Dim>
    template<class ForceModel, class Executor>
    void RPMD<ScalarType, PosScalarType, Dim>::nve_step(const ForceModel& force) {
        forceStep(timeStep * 0.5);
    ...
    void RPMD<ScalarType, PosScalarType, Dim>::npt_step(RandomGenerator& gen, Barostat& barostat, const ForceModel& force) {
    ...
    template<class ScalarType, class PosScalarType, unsigned int Dim>
    template<class RandomGenerator, class ForceModel, class Executor>
    void RPMD<ScalarType, PosScalarType, Dim>::nvt_step_for(ScalarType duration, RandomGenerator& gen, const ForceModel& force) {
