...
namespace Physica {
    ...
    public:
        ...
        constexpr static double b_OO = 2.76 * PhyConst<AU>::bohrToAngstrom(1);
        ...
        constexpr static double b_SiO = 4.87318 * PhyConst<AU>::bohrToAngstrom(1);
    ...
    template<Scalar T, class EwaldType, bool AvoidTooNear>
    BKSModel<T, EwaldType, AvoidTooNear>::BKSModel(const MDCellType& refer_cell, Tv cutoff, EwaldType ewald_)
            : Base(cutoff)
