...
namespace Physica {
    ...
    public:
        ...
        [[nodiscard]] __host__ __device__ auto&& getLattice(this auto&& self) noexcept { return self.lattice; }
        [[nodiscard]] __host__ __device__ auto&& getPos(this auto&& self) noexcept { return self.pos; }
