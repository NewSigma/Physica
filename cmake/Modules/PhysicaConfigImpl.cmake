    ...
    elseif (CMAKE_CXX_COMPILER_ID MATCHES Clang OR CMAKE_CXX_COMPILER_ID MATCHES IntelLLVM)
        ...
        if(${PHYSICA_EmitLLVM})
            ...
            if(${PHYSICA_TRANSFORMS})
                message(FATAL_ERROR "EmitLLVM is incompatible with Transforms")
            endif()
...
if(${PHYSICA_CUDA})
    ...
    if(CMAKE_CUDA_COMPILER_ID MATCHES Clang)
        ...
        # Warning 20039-D: __host__ redeclared with __device__; FIXME: NVCC false positive diagnoise on abbreviated function templates, remove it once we bump to CUDA 13.2
        # Warning 20040-D: __host__ redeclared with __device__; FIXME: NVCC false positive diagnoise on abbreviated function templates, remove it once we bump to CUDA 13.2
